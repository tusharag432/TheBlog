...
$where = "";
	...
	else
	{
        if(empty($where))
		{
            $where .= "WHERE catgeory like '%".$keyword6."%' ";
        }
		else
		{
            $where .= " AND title like '%".$keyword6."%' ";
        }    
    }
